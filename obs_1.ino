...
#define MAX_DISTANCE 600 // sets maximum useable sensor measuring distance to 300cm
...
{ //Mert Arduino https://bit.ly/MertArduino
  ...
  delay(500); // delay for one seconds
}
//------------------------------------------------------------------------------------------------------------------------------------
...
void changePath() { 
  ...
  myservo.write(45);  // check distance to the right
   delay(500);
    rightDistance = readPing(); //set right distance
    delay(500);
    myservo.write(135);  // check distace to the left
    delay(500);
